...
class NoteSplash extends FlxSprite
{
	...
	var maxAnims:Int = 2;
	public function setupNoteSplash(x:Float, y:Float, direction:Int = 0, ?note:Note = null, ?noteTexture:String) {
		...
		{
			if(noteTexture == 'noteSkins/NOTE_assets' || noteTexture == 'noteSkins/NOTE_assets-unused' || noteTexture == 'noteSkins/NOTE_assets-unused2')
			{
				texture = defaultNoteSplash + "-craftee";
			}else if(noteTexture == 'noteSkins/NOTE_assets-lightblue' || noteTexture == 'noteSkins/NOTE_assets-revision1' || noteTexture == 'noteSkins/NOTE_assets-revision1lightblue' || noteTexture == 'noteSkins/NOTE_assets-legacy' || noteTexture == 'noteSkins/NOTE_assets-unused3' || noteTexture == 'noteSkins/NOTE_assets-unused4' || noteTexture == 'noteSkins/NOTE_assets-unused5')
			{
				texture = defaultNoteSplash + "-lightblue";
			}else if(noteTexture == 'noteSkins/NOTE_assets-basegame')
			{
				texture = defaultNoteSplash + "-og";
			}else
			{
