...
class EditorPlayState extends MusicBeatSubstate
{
	...
	public function new(playbackRate:Float)
	{
		...
		if(playerStrums.members[0].texture == 'noteSkins/NOTE_assets' || playerStrums.members[0].texture == 'noteSkins/NOTE_assets-lightblue' || playerStrums.members[0].texture == 'noteSkins/NOTE_assets-basegame' || playerStrums.members[0].texture == 'noteSkins/NOTE_assets-revision1' || playerStrums.members[0].texture == 'noteSkins/NOTE_assets-revision1lightblue' || playerStrums.members[0].texture == 'noteSkins/NOTE_assets-legacy' || playerStrums.members[0].texture == 'noteSkins/NOTE_assets-unused' || playerStrums.members[0].texture == 'noteSkins/NOTE_assets-unused2' || playerStrums.members[0].texture == 'noteSkins/NOTE_assets-unused3' || playerStrums.members[0].texture == 'noteSkins/NOTE_assets-unused4' || playerStrums.members[0].texture == 'noteSkins/NOTE_assets-unused5')
		{
	...
	function spawnNoteSplash(x:Float, y:Float, data:Int, ?note:Note = null) {
		...
		splash.setupNoteSplash(x, y, data, note, playerStrums.members[0].texture);
		grpNoteSplashes.add(splash);
	}
